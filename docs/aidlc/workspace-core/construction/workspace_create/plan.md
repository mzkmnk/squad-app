...
- [ ] `src/app/services/workspace.service.ts` を作成（`window.electronAPI` の薄いラッパー）
- [ ] テスト: `src/app/services/workspace.service.spec.ts` を作成
...
- [ ] `src/app/workspaces/workspace-create.ts` を作成（シグナル・ロジック・auto-fetch）
- [ ] `src/app/workspaces/workspace-create.html` を作成（テンプレート）
- [ ] テスト: `src/app/workspaces/workspace-create.spec.ts` を作成
...
- [ ] `src/app/app.routes.ts` に `/workspaces/new` ルートを追加
- [ ] `src/app/repos/repo-list.ts` に Workspace 作成画面への遷移ボタンを追加
- [ ] `src/app/repos/repo-list.html` のヘッダーに「Workspace を作成」ボタンを追加
